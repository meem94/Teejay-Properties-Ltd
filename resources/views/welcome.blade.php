...
<div class="leaves">
    <div class="container">
        <div class="leaves-main wow zoomIn" data-wow-delay="0.1s">
...
<div class="information">
    <div class="container">
        <div class="information-main">
              <div class="information-grid five-star wow slideInLeft" data-wow-delay="0.1s">
                ...
                <div class="col-md-4 hotel-info">
                    ...
                    <div class="info-right">
                        <h4>Secure</h4>
                        <p>The privacy of your own front door, plenty of space and a relaxing environment where you can come and go as you please.</p>
                    </div>
                  <div class="clearfix"> </div>
                </div>
                <div class="clearfix"> </div>
              ...
              <div class="information-grid wow slideInRight" data-wow-delay="0.3s">
                ...
                <div class="col-md-4 hotel-info">
                    ...
                    <div class="info-right">
                        <h4>Experience</h4>
                        <p>You will have your own front door and the opportunity not to just visit London but to really live there!</p>
                    </div>
                  <div class="clearfix"> </div>
                </div>
                <div class="col-md-4 hotel-info">
    ...
    <div class="container">
        <div class="footer-main">
            ...
            <div class="col-md-3 ftr-grid ftr-rit wow zoomIn" data-wow-delay="0.3s">
                 <h3>Contact Us</h3>
                  <div class="ftr-tle">
                        <h4 class="white no-padding">Email</h4>
                    </div>
                    <div class="info-sec">
                        <p><i class="fa fa-envelope-o fa-fw pull-left fa-2x"></i>jaytholiday2017@gmail.com</p>
                    </div>
            </div>
            <div class="col-md-3 ftr-grid ftr-rit wow zoomIn" data-wow-delay="0.3s">
                 <h3>Follow Us</h3>
