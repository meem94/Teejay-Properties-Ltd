		...
		<div class="banner1">
    		<div class="container">
        		<div class="banner-main wow zoomIn" data-wow-delay="0.3s">
		            <h2>5 Bed House in Stock Newington</h2>
		        </div>
		    </div>
		</div>
		...
		<div class="rooms">
			<div class="container">
				<div class="rooms-main">
					<div class="room-head">
						<h3>5 Bed HOUSE! 2 Bath! Cute GARDEN! in Stoke Newington</h3>
					</div>
					<div class="rooms-top">
						...
						<div class="rooms-left wow slideInLeft" data-wow-delay="0.3s">
							<div class="rooms-text">
								<h2>Description</h2>
								<h4>£115 per night</h4>
								<p style="margin-top: 15px;">This is a maisonette (two storeys) 5 bed room house with living room with a nice garden. 
